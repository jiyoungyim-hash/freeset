        ...
        <div className="upload-panel">
          ...
          <div className="setting-block">
            ...
            <div className="crop-rows">
              ...
              <label className="crop-row">
                <input type="radio" name="crop" value="smart-fill" checked={cropMode === 'smart-fill'} onChange={() => setCropMode('smart-fill')} />
                <div>
                  <div className="crop-label">
                    스마트 배경 확장
                    <span style={{ fontSize: 10, color: '#0ea5e9', fontWeight: 600, marginLeft: 6, background: 'rgba(14,165,233,0.12)', padding: '1px 6px', borderRadius: 4 }}>NEW</span>
                  </div>
                  <div className="crop-desc">이미지 가장자리를 거울 반사로 확장해 여백 없이 자연스럽게 채움</div>
                </div>
              </label>
              <label className="crop-row">
